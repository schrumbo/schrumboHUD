...
public class ArmorRenderer implements HudElement {
    ...
    public void extractRenderState(GuiGraphicsExtractor drawContext, DeltaTracker renderTickCounter) {
        ...
        if (config.general.hideInScreens && !client.canInterruptScreen()) return;
        ...
        renderRarityBackgrounds(drawContext);
    ...
    private void renderRarityBackgrounds(GuiGraphicsExtractor context) {
